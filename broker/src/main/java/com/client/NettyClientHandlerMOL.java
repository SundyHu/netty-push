...
public class NettyClientHandlerMOL extends SimpleChannelInboundHandler<BaseMsg> {
	private NettyClientMOL clientMOL;
	private SendMsg sendMsg;
	static Logger logger = Logger.getLogger(NettyClientHandlerMOL.class);
	
	public NettyClientHandlerMOL(NettyClientMOL client) {
		this.clientMOL=client;
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
    	...
    	sendMsg.login(clientMOL.getChannelFuture());
    }
...
//                System.out.println("receive ping from server----------");
            ...
            case ASK:{
                ...
                String res=MOLJdbcUtil.excuteQuery(MOLJdbcUtil.getConnection(),sql);
