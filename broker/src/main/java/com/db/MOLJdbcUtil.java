...
public class MOLJdbcUtil {
	static Logger logger = Logger.getLogger(MOLJdbcUtil.class);
	private static ComboPooledDataSource ds = new ComboPooledDataSource("MOLmysql");
